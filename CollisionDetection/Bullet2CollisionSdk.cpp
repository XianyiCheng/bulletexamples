...
plCollisionShapeHandle Bullet2CollisionSdk::createBoxShape(plCollisionWorldHandle worldHandle, 
	plReal half_length, plReal half_width, plReal half_height){
	
	btVector3 boxHalfExtents(half_length, half_width, half_height);
