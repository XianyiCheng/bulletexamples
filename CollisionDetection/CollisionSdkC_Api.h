...
extern "C"
{
	...
	extern plCollisionShapeHandle plCreateBoxShape(plCollisionSdkHandle sdk, plCollisionWorldHandle worldHandle, plReal half_length, plReal half_width, plReal half_height);
